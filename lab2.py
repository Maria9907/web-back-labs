...
def flowers(flower_id):
    ...
    return render_template('lab2/one_flower.html', flower=flower, flower_id=flower_id)
...
def example():
    ...
    return render_template(
        "lab2/example.html", name=name, group=group, course=course, lab=lab, fruits=fruits
    )
...
cat_breeds = [
    ...
    },
    {
        ...
        "image": "lab2/саванна.jpg"  
    }
]

@lab2.route('/lab2/cat_breeds')
def show_cat_breeds():
    return render_template('lab2/cat_breeds.html', cat_breeds=cat_breeds)